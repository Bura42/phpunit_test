...
class CollectionTest extends TestCase
{
    ...
    public function items_returned_mathc_items_passed_in()
    {
        $collection = new \App\Support\Collection(
            [
                'one',
    ...
    public function collection_is_instance_od_iterator_aggregate()
    {
        $collection = new \App\Support\Collection();
    ...
    public function collection_cam_be_merged_with_another_collection()
    {
